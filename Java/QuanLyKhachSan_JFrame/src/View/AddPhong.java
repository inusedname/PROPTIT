...
public class AddPhong extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        newRoomTypeCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "VIP", "Chat luong cao", "Thuong" }));
    ...
    private void creatRoomButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_creatRoomButtonActionPerformed
        ...
        if (name.length() == 0) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Họ tên chỉ chứa chữ cái");
            isOK = false;
        }
        if (isOK) {
            Phong newPhong = new Phong(name, type);
            JOptionPane.showMessageDialog(rootPane, "Thêm mới thành công");
            home.addPhong(newPhong);
            this.dispose();
        }
